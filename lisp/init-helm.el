...
;;(add-to-list 'load-path "~/.emacs.d/elpa/helm-3.5.0")
...
(use-package helm
  ...
  (progn
    ...
    (define-key helm-buffer-map (kbd "s-g") 'helm-buffer-run-zgrep)
    (define-key helm-buffer-map (kbd "s-d") 'helm-buffer-run-kill-persistent)
    ...
    ;;use helm-apropos instead counsel-describe-function
